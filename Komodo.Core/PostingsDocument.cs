...
namespace Komodo
{
    ...
    public class PostingsDocument
    {
        ...
        public PostingsDocument(string sourceDocGuid, string ownerGuid, string indexGuid, DocType docType, long contentLength, long terms, long postings)
        {
        ...
        /// <param name="postings">The number of postings in the parsed document.</param>
        /// <param name="contentLength">The content length of the parsed document.</param>
        public PostingsDocument(string guid, string sourceDocGuid, string ownerGuid, string indexGuid, DocType docType, long contentLength, long terms, long postings)
        {
