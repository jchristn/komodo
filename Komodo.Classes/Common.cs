...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
        public static List<T> aGenericToSpecificList<T>(List<object> source)
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
        {
...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
        public static List<object> aDataTableToListObject(DataTable dt, string objType)
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
        {
            //
...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
        public static object aDataTableToObject(DataTable dt, string objType)
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
        {
            if (dt == null) return null;
            if (dt.Rows.Count != 1) return null;
...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
        public static T aDataTableToObject<T>(this DataTable table) where T : new()
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
        {
...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
        public static IList<T> aDataTableToList<T>(this DataTable table) where T : new()
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
        {
            IList<PropertyInfo> properties = typeof(T).GetProperties().ToList();
            IList<T> result = new List<T>();
